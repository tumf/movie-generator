...
export VOICEVOX_DICT_DIR="$VOICEVOX_DIR/dict"
export VOICEVOX_MODEL_PATH="$VOICEVOX_DIR/models/0.vvm"
EOF
...
if [ $? -eq 0 ]; then
	...
	echo "     export VOICEVOX_DICT_DIR=\"$VOICEVOX_DIR/dict\""
	echo "     export VOICEVOX_MODEL_PATH=\"$VOICEVOX_DIR/models/0.vvm\""
	echo ""
	echo "  3. Test with:"
